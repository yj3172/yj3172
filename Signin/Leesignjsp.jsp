...
<script src="js/scriptsignup.js"></script>
 ...
 <body bgcolor="#364f6b">
  ...
  <table cellpadding=5 cellspacing=0 align="center">
	...
	<tr>
		<td colspan="3"><font color="red">*</font>비밇번호 </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<tr>
		<td colspan="3"><font color="red">*</font>비밀번호 찾기 질문</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3"><font color="red">*</font>비밀번호 찾기 답</td>
	</tr>
	...
	<tr>
		...
		<td> <input type = "button" name ="adrfind" value="주소찾기" onclick="주소검색"style="width:100px;height:30;"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3"><font color="red">*</font>성별 </td>
	</tr>
	<tr>
		<td colspan="3"> 남자 : <input type = "radio" name="gender" value="남" checked> 여자 : <input type = "radio" name="gender" value="여"></td>
	</tr>
	<tr>
